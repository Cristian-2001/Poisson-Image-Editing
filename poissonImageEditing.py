...
if __name__ == '__main__':
    '''
    Example usage of the Poisson image editing function.
    It is possible to test all the functionalities of this code using the provided images.
    '''
    ...
    im_result.save('testimages/result_prova.png', 'PNG')
    im_result.show()
